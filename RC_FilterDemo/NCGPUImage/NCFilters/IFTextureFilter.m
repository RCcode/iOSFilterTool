#import "IFTextureFilter.h"

NSString *const kTextureFilterShaderString = SHADER_STRING
(
...
@implementation IFTextureFilter
 int timeUniformLocation;


- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kTextureFilterShaderString]))
    {
		return nil;
    }
